        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'home')) }}"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    </svg><span class="side-menu__label">برنامج الفواتير</span><span
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'bull')) }}">قائمه الفواتير </a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'arc')) }}">الفواتير المؤرشفه</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'paidbull')) }}">الفواتير المدفوعه</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'inpaidbull')) }}">الفواتير الغير مدفوعة</a></li>
        ...
        <li class="side-item side-item-category">التقارير</li>
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'creports')) }}">تقارير العملاء</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'sections')) }}">الافسام</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'Produtes')) }}"> المنتجات</a></li>
